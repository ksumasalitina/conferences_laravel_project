...
trait ZoomJWT
{
    ...
    public function createZoom(ZoomRequest $request)
    {
    ...
    public function updateZoom(ZoomRequest $request,$id)
    {
        $path = 'meetings/' . $id;
        $response = $this->zoomPatch($path, [
            'topic' => $request['topic'],
            'type' => 2,
            'start_time' => (new \DateTime($request['start_time']))->format('Y-m-d\TH:i:s'),
            'duration' => 60,
            'agenda' => $request['agenda'],
            'settings' => [
                'host_video' => false,
